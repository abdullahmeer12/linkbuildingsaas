...
const BrandOne = () => {
    ...
    return (
        <>
            {/* brand one start */}
            <div className="brand-one pt-80 pb-80 wow fadeInUp" data-wow-delay=".3s">
                <div className="container">
                    <div className="row">
                        <h2 className="brand-one__title">Trusted by top brands & SEO agencies for first page results</h2>
                    </div>
