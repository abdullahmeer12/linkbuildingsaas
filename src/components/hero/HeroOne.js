        ...
        <>
            <div className="hero-one" style={{backgroundImage: `url(${BackgroundOne.src})`}}>
                <div className="hero-one__wrapper">
                    ...
                    {/* <div className="hero-one__animation-2">
                    <img src="/assets/img/banner-new.png" alt="rocket img" />
                    </div> */}
                        ...
                        <div className="row">
                            <div className="col-xxl-12 col-xl-7 col-lg-12 col-md-12 col-sm-12">
                                <div className="hero-one__content wow fadeInLeft" data-wow-delay=".3s">
                                    <h2>Amplify Your Organic Reach With  <span className="hero-highlighter-1"> 
                                    High Quality  Backlinks
                                        ...
                                        <br /> </h2>
                                    <p>We help online businesses establish themselves as an industry thought <br/> leader and dominate SERPs with our link building prowess.</p>
                                    <Link href="/contact" className="hero-btn-1 rr-btn-style-1" > Get Backlinks Now</Link>
                                    {/* <form action="#">
